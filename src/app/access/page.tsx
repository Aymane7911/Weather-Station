...
import { Users, Shield, Check, X, Search, Loader2, AlertCircle, CheckCircle, XCircle, Cloud, ArrowLeft, RefreshCw } from 'lucide-react';
...
const AdminAccessManagement = () => {
  ...
  const checkAdminAccess = async () => {
    try {
      ...
      // The user object is nested inside data.user
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-200 text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl mb-6 shadow-lg mx-auto">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3.5 rounded-xl font-bold text-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Manage user access to weather stations</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={fetchUsers}
                className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-5 py-2.5 rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg font-semibold text-sm"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-red-600 to-orange-600 text-white px-5 py-2.5 rounded-xl hover:from-red-700 hover:to-orange-700 transition-all duration-300 shadow-md hover:shadow-lg font-semibold text-sm"
              >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 text-xs">
                          ...
                          <span className={`flex items-center gap-1 ${
                            user.isAccessGranted ? 'text-blue-600' : 'text-gray-400'
                          }`}>
                  ...
                  <div className="space-y-3 max-h-[500px] overflow-y-auto">
                    {containers.map((container) => {
                      ...
                      return (
                        <div
                          key={container.name}
                          className="flex items-center justify-between p-4 rounded-xl border-2 border-gray-200 hover:border-indigo-300 transition-all"
                        >
                          <div className="flex items-center gap-3">
